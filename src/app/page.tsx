    ...
    <>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-4" style={{ background: '#0f0f0f' }}>
        ...
        <div className="w-full max-w-md">
          ...
          >
            <span className="flex items-center justify-center w-9 h-9 rounded-lg bg-orange-500 group-hover:bg-orange-400 transition-colors">
          ...
          {/* Panel */}
          <div className="border border-white/8 rounded-2xl p-8 shadow-2xl shadow-black/60" style={{ background: '#141414' }}>
